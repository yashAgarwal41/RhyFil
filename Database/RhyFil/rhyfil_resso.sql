...
--
-- Table structure for table `resso`
--

DROP TABLE IF EXISTS `resso`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `resso` (
  `service_dpid` varchar(200) DEFAULT NULL,
  `report_start_date` varchar(200) DEFAULT NULL,
  `report_end_date` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `resso`
--

LOCK TABLES `resso` WRITE;
/*!40000 ALTER TABLE `resso` DISABLE KEYS */;
/*!40000 ALTER TABLE `resso` ENABLE KEYS */;
UNLOCK TABLES;
